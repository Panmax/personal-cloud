...
export function BatchActionBar({ onDelete, onMove }: Props) {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 px-3 py-2 bg-white border border-slate-200 rounded-xl shadow-lg sm:gap-3 sm:px-5 sm:py-2.5 sm:bottom-6 max-w-[90vw]">
